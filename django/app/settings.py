...
SECRET_KEY = 'django-insecure-t2kvm2i_0fwb*z))^mt9(5q7a9i*@&4hr&6zq0@pxo7ousv9*t'
...
DATABASES = {
    'default': {
    # o docker coloca as variáveis da sessão environment como variaveis de ambiente do conteiner :) 
